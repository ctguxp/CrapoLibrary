...
namespace System
  ...
  String NumberFormatter::NumberToString(int value, IFormatProvider* fp)
    {
  ...
  // ------------------------------------------------------------------------
  /// Public Static NumberToString function (Based on Mono)
  String NumberFormatter::NumberToString(String* format, int value, IFormatProvider* fp)
    {
    GCNumberFormatter inst(GetInstance());
...
#pragma warning (default:4715)
  ...
  void NumberFormatter::InitHex(ulong value)
    {
